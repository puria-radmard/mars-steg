...
class SequentialPriceGameGenerator:
    ...
    def generate_dataset(self, num_episodes, output_path=None, overwrite=False, seed=42):
        list_to_df = []
...
if __name__ == '__main__':
    ...
    generator.generate_dataset(num_episodes=10, output_path=None, overwrite=False, seed=42)
